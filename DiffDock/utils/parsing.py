...
def parse_train_args():
    ...
    parser.add_argument(
        "--pretrain_dir",
        type=str,
        help="Folder of pretrained model from which to restart",
    )
    ...
    parser.add_argument(
        "--moad_dir",
        type=str,
        default="data/BindingMOAD_2020_processed/",
    ...
    parser.add_argument(
        "--combined_training", action="store_true", default=False, help=""
    )
    ...
    parser.add_argument(
        "--unroll_clusters", action="store_true", default=False, help=""
    )
    parser.add_argument(
        "--enforce_timesplit", action="store_true", default=False, help=""
    )
    parser.add_argument("--merge_clusters", type=int, default=1, help="")
    parser.add_argument(
        "--triple_training", action="store_true", default=False, help=""
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="option to use old atom encoder for backward compatibility",
    )
    parser.add_argument(
        "--depthwise_convolution", action="store_true", default=False, help=""
    )
    ...
    parser.add_argument(
        "--pdbsidechain_dir", type=str, default="data/pdb_2021aug02_sample", help=""
    )
    parser.add_argument(
        "--pdbsidechain_esm_embeddings_path", type=str, default=None, help=""
    )
    parser.add_argument(
        "--pdbsidechain_esm_embeddings_sequences_path", type=str, default=None, help=""
    )
    ...
    parser.add_argument(
        "--remove_second_segment", action="store_true", default=False, help=""
    )

    args = parser.parse_args()

    assert (not args.dynamic_max_cross) or (
        args.tr_sigma_max * 3 + 20 < args.cross_max_distance
    )
