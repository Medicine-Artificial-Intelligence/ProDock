...
def construct_loader(args, t_to_sigma, device):
    ...
    if args.dataset == "pdbsidechain" or args.triple_training:
        if args.pdbsidechain_esm_embeddings_path is not None:
            ...
            sequences_list = read_strings_from_txt(
                args.pdbsidechain_esm_embeddings_sequences_path
            )
    ...
    if args.dataset == "pdbsidechain" or args.triple_training:
        ...
        if args.dataset == "pdbsidechain":
            ...
            val_dataset = PDBSidechain(
                cache_path=args.cache_path,
                split="val",
                multiplicity=args.val_multiplicity,
                **common_args
            )
    ...
    if args.dataset in ["pdbbind", "moad", "generalisation", "distillation"]:
        ...
        if (
            ...
            or args.dataset == "generalisation"
            or args.combined_training
        ):
        ...
        if args.dataset == "moad" or args.combined_training:
            train_dataset2 = MOAD(
                ...
                enforce_timesplit=args.enforce_timesplit,
                **common_args
            )
