...
class TestQVinaEngineUnit(unittest.TestCase):
    ...
    def test_init_defaults(self) -> None:
        ...
        self.assertEqual(engine.exe_name, "qvina")
    ...
    def test_flag_map_does_not_include_autobox_flags(self) -> None:
        ...
        """
        self.assertNotIn("autobox_ligand", QVinaEngine.flag_map)
        self.assertNotIn("autobox_add", QVinaEngine.flag_map)
    ...
    def test_load_config_dict_applies_values(self) -> None:
        ...
        .. code-block:: python
            ...
            engine = QVinaEngine().load_config_dict(
                {
                    "box": {
        ...
        engine = QVinaEngine().load_config_dict(config)
    ...
    def test_load_config_reads_json_file(self) -> None:
        ...
        engine = QVinaEngine().load_config(config_path)
    ...
    def test_validate_ready_raises_without_box(self) -> None:
        ...
        engine = QVinaEngine().set_receptor(receptor).set_ligand(ligand)
    ...
    def test_resolve_executable_accepts_explicit_executable(self) -> None:
        ...
        engine = QVinaEngine().set_executable(exe)
