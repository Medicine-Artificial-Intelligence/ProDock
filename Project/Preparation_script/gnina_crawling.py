...
parser.add_argument('--output_dir', type=str, default=".", help="Directory to save the output CSV (defaults to current directory)")
parser.add_argument('--output_name', type=str, default="best_ligand_score", help="Name of the csv file of docking score of the best conformations")
